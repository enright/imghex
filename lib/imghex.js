...
exports.clientHexMapTemplate = minifier(jade.compile("include hexMapMixin\nmixin hexMap(ranks, files, width, height, defaultImageURL, boardClass, boardRowClass, boardRowEvenClass, boardRowOddClass, boardTileClass,boardFirstTileClass)", { filename: __dirname + '/../views/.', compileDebug: false, client: true }).toString());

// more to come?
exports.clientSquareMapTemplate = minifier(jade.compile("include squareMapMixin\nmixin squareMap(ranks, files, width, height, defaultImageURL, boardClass, boardRowClass, boardTileClass)", { filename: __dirname + '/../views/.', compileDebug: false, client: true }).toString());