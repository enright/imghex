...
module.exports = function (jadeOptions, mangleOptions, squeezeOptions, genOptions) {
    ...
    var hexMapMixin = "include hexMapMixin\nmixin hexMap(ranks, files, width, height, defaultImageURL, boardClass, boardRowClass, boardRowEvenClass, boardRowOddClass, boardTileClass, boardFirstTileClass)",
        hexMapDivMixin = "include hexMapDivMixin\nmixin hexMapDiv(ranks, files, width, height, defaultImageURL, divClass, boardClass, boardRowClass, boardRowEvenClass, boardRowOddClass, boardTileClass, boardFirstTileClass)",
        ...
        squareMapDivMixin = "include squareMapDivMixin\nmixin squareMapDiv(ranks, files, width, height, defaultImageURL, divClass, boardClass, boardRowClass, boardTileClass)",
        hexMap,
        hexMapTemplate,
        hexMapDiv,
        hexMapDivTemplate,
